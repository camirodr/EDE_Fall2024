...
> Answer:In a matrix you have to define how many rows and columns you want as an output given the data you have. A matrix is homogenous, unlike data frames which can have heterogeneous data. Columns/rows in data frames have named vectors such as student names, grades, etc. Visualization is also better for data frames compared to matrices. 
...
larger_than_fifty_simple <- function(x){
...
larger_than_fifty_simple(grades)
```
