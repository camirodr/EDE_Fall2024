...
EPA_2018_ozone_parameters<- select(EPA_2018_ozone, Date, DAILY_AQI_VALUE, Site.Name, AQS_PARAMETER_DESC, COUNTY:SITE_LONGITUDE)
EPA_2019_ozone_parameters<-select(EPA_2019_ozone,Date, DAILY_AQI_VALUE, Site.Name, AQS_PARAMETER_DESC, COUNTY: SITE_LONGITUDE)
EPA_2018_PM25_parameters<- select(EPA_2018_PM25, Date, DAILY_AQI_VALUE, Site.Name, AQS_PARAMETER_DESC, COUNTY: SITE_LONGITUDE)
EPA_2019_PM25_parameters<- select(EPA_2019_PM25,Date, DAILY_AQI_VALUE, Site.Name, AQS_PARAMETER_DESC, COUNTY: SITE_LONGITUDE)


#5


EPA_2018_PM25_parameters<- mutate(EPA_2018_PM25_parameters, AQS_PARAMETER_DESC = "PM2.5") 
EPA_2019_PM25_parameters<- mutate(EPA_2019_PM25_parameters, AQS_PARAMETER_DESC = "PM2.5") 
...
write.csv(EPA_2018_PM25_parameters, row.names = FALSE, file = "./Data/Processed/EPAair_PM25_NC2018_Processed.csv")
write.csv(EPA_2019_PM25_parameters, row.names = FALSE, file = "./Data/Processed/EPAair_PM25_NC2019_Processed.csv")
write.csv(EPA_2018_ozone_parameters, row.names = FALSE, file = "./Data/Processed/EPAair_O3_NC2018_Processed.csv")
write.csv(EPA_2019_ozone_parameters, row.names = FALSE, file = "./Data/Processed/EPAair_O3_NC2019_Processed.csv")
