...
```{r, fig.height=4, fig.width=8, echo=FALSE, warning=FALSE, fig.cap="2018 monthly Ozone levels"}

Ozone_filtered_18<- filter(epa_data, Year == 2018)

Ozone_2018<- ggplot(Ozone_filtered_18, aes(x=factor(
  Month, levels=1:12,labels=month.abb), y=Ozone ))+
  geom_boxplot()+ labs(title= "Monthly Ozone concentrations(2018)", x="Month", y = expression(paste("Concentration (", mu, "g/m"^{3}, ")")))
...
```{r, fig.height=4, fig.width=8, fig.cap="2019 monthly Ozone levels", message=FALSE, warning=FALSE, echo=FALSE}

Ozone_filtered_19<-filter(epa_data, Year == 2019)

Ozone_2019<- ggplot(Ozone_filtered_19, aes(x=factor(
  Month, levels=1:12,labels=month.abb), y=Ozone ))+ 
  geom_boxplot()+labs(title= "Monthly Ozone concentrations(2019)", x="Month", y = expression(paste("Concentration (", mu, "g/m"^{3}, ")")))
...
https://github.com/camirodr/EDE_Fall2024
