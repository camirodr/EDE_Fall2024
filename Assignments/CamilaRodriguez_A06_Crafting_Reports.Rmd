...
```{r, fig.height=4, fig.width=6, echo=FALSE, warning=FALSE, fig.cap="2018 monthly Ozone levels"}
...
```{r, fig.height=4, fig.width=6, fig.cap="2019 monthly Ozone levels", message=FALSE, warning=FALSE, echo=FALSE}
